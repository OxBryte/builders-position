...
export default function LeaderboardPagination({
  ...
  return (
    <footer className="flex flex-col items-center justify-between gap-4 rounded-3xl border border-gray-100 bg-white/90 p-4 shadow-sm ring-1 ring-black/5 sm:flex-row sm:gap-6">
